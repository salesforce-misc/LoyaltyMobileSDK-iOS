...
struct PromotionCarouselView: View {
    ...
    let offers = [
        ...
        Offer(offerImage:"promotion3", offerTitle: "Disneyland for Family of 4", offerDescription: "The ultimate family vacation destination is a not a dream anymore", offerExpirationDate: "01/31/2023")
    ]
