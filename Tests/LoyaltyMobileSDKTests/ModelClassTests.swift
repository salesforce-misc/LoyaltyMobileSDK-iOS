...
final class ModelClassTests: XCTestCase {
    ...
    func testTransactionModel() throws {
        let transactionJournal = TransactionJournal(activityDate: "10 November 2022",
                                                  additionalTransactionJournalAttributes: [AdditionalTransactionJournalAttribute(fieldName: "fieldName", value: "value")],
        ...
        let transactionModel = TransactionModel(message: "success", status: true, transactionJournalCount: 1, externalTransactionNumber: "001", transactionJournals: [transactionJournal])
        XCTAssertEqual(transactionModel.message, "success")
    }
    
    func testBenefitModel() throws {
        let benefitModel = BenefitModel(id: "0ji4x0000008REdAAM", benefitName: "Extended Returns (7 Days)", benefitTypeID: "0jh4x0000008REQAA2", benefitTypeName: "Extended Returns", createdRecordID: "001", createdRecordName: "Return", description: "description", endDate: "10 November 2022", isActive: true, memberBenefitStatus: "active", startDate: "9 November 2022")
