...
final class PromotionViewModelTests: XCTestCase {
    ...
    func testFetchCarouselPromotions() async throws {
        ...
        XCTAssertEqual(viewModel.promotions[0].id, "0c84x000000CoNhAAK")
        XCTAssertEqual(viewModel.promotions[1].id, "0c84x000000CoNiAAK")
        XCTAssertEqual(viewModel.promotions[2].id, "0c84x000000CtzRAAS")
        XCTAssertEqual(viewModel.promotions[3].id, "0c84x000020CtzWAAS")
        XCTAssertEqual(viewModel.promotions[4].id, "0c84x004000CoNhAAK")
    }
    ...
    func testLoadAllPromotions() async throws {
        ...
        try await viewModel.loadAllPromotions(membershipNumber: "1234", devMode: true)
        XCTAssertTrue(viewModel.allEligiblePromotions.count == 7)
        XCTAssertEqual(viewModel.allEligiblePromotions[0].id, "0c84x000000CoNhAAK")
        XCTAssertEqual(viewModel.allEligiblePromotions[1].id, "0c84x000000CoNiAAK")
        XCTAssertEqual(viewModel.allEligiblePromotions[2].id, "0c84x000000CtzRAAS")
        XCTAssertEqual(viewModel.allEligiblePromotions[3].id, "0c84x000020CtzWAAS")
        XCTAssertEqual(viewModel.allEligiblePromotions[4].id, "0c84x004000CoNhAAK")
        XCTAssertEqual(viewModel.allEligiblePromotions[5].id, "0c84x000006CoNiAAK")
        XCTAssertEqual(viewModel.allEligiblePromotions[6].id, "0c84x070000CtzRAAS")
    }
    ...
    func testFetchActivePromotions() async throws {
        ...
        XCTAssertTrue(viewModel.activePromotions.count == 5)
        XCTAssertEqual(viewModel.activePromotions[0].id, "0c84x000000CoNhAAK")
        XCTAssertEqual(viewModel.activePromotions[1].id, "0c84x000000CoNiAAK")
        XCTAssertEqual(viewModel.activePromotions[2].id, "0c84x000020CtzWAAS")
        XCTAssertEqual(viewModel.activePromotions[3].id, "0c84x004000CoNhAAK")
